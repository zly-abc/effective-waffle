      ...
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="segment" label="第几大节">
          <el-select v-model="form.segment" placeholder="请选择类型" style="width: 100%" :disabled="user.role !== 'ADMIN'">
            <el-option label="第一大节（08:00 ~ 09:45）" value="第一大节（08:00 ~ 09:45）"></el-option>
            <el-option label="第二大节（10:15 ~ 12:00）" value="第二大节（10:15 ~ 12:00）"></el-option>
            <el-option label="第三大节（14:00 ~ 15:45）" value="第三大节（14:00 ~ 15:45）"></el-option>
            <el-option label="第四大节（16:15 ~ 18:00）" value="第四大节（16:15 ~ 18:00）"></el-option>
            <el-option label="第五大节（19:00 ~ 20:45）" value="第五大节（19:00 ~ 20:45）"></el-option>
          </el-select>
        </el-form-item>

...
import com.shuang.dormitory.common.CalPeopleNum;
import com.shuang.dormitory.common.JudgeBedName;
import com.shuang.dormitory.entity.AdjustRoom;
import com.shuang.dormitory.entity.DormRoom;
import com.shuang.dormitory.mapper.DormRoomMapper;
...
public class DormRoomImpl extends ServiceImpl<DormRoomMapper, DormRoom> implements DormRoomService {
    ...
    public int updateNewRoom(DormRoom dormRoom) {
        return dormRoomMapper.updateById(dormRoom);
    }
    ...
    public DormRoom judgeHadBed(String username) {
        ...
        return dormRoomMapper.selectOne(qw);
    }
    ...
    public Long selectHaveRoomStuNum() {
        ...
        return first_bed + second_bed + third_bed + fourth_bed;
    }
    ...
    public int adjustRoomUpdate(AdjustRoom adjustRoom) {
        ...
        int currentCapacity1 = CalPeopleNum.calNum(dormRoom1);
        ...
        int currentCapacity2 = CalPeopleNum.calNum(dormRoom2);
    ...
    public DormRoom checkRoomExist(Integer dormRoomId) {
        return dormRoomMapper.selectById(dormRoomId);
    }
